...
<div style="display:inline">
 <div class="bg-blue" style="background:blue;float:left;border:1px black" width="49%">hello</div>
 <div class="bg-blue" style="background:red;float:right;border:1px black" width="49%">hello</div>
</div>
<div style="display:inline">  
